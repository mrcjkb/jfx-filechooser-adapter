...
include(":jfx-filechooser-adapter", ":jfx-filechooser-adapter-api", ":jfx-filechooser-adapter-impl")
project(":jfx-filechooser-adapter").projectDir = File(settingsDir, "../jfx-filechooser-adapter-parent")
